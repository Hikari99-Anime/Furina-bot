...
// ==========================================
// KIỂM TRA CÓ PHẢI CÁ THẬT KHÔNG
// ==========================================

function isRealFish(fish) {

    /*
     * Nếu fish không có isFish
     * thì mặc định vẫn coi là cá.
     *
     * Nếu:
     * isFish: false
     * => item rác / ủng / vật phẩm
     */
...
function generateQuest() {
    ...
    if (type === 4) {
        ...
        /*
         * Nếu không có cá thật
         * thì quay lại tạo quest khác.
         */
...
function getFishCount(user) {
    ...
    for (
        ...
        /*
         * Không có thông tin fish
         * => bỏ qua để tránh tính nhầm item.
         */
...
function createDailyQuests() {
    ...
    /*
     * Trong trường hợp không tạo đủ 5 quest
     * vì config quá ít loại,
     * vẫn trả về những quest tạo được.
     */
